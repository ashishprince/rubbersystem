"""
Django settings for rubber_system project.
...
SECRET_KEY = 'django-insecure-w&_@_+uzu0)auh6w_q@@s=*jrgwvufyx@47^swdy9f3_1xj+k@'
...
ROOT_URLCONF = 'rubber_system.urls'
...
WSGI_APPLICATION = 'rubber_system.wsgi.application'
...
# WhiteNoise settings for production caching
...
# Weather API
WEATHER_API_KEY = os.environ.get('WEATHER_API_KEY', 'demo_key_provide_one_in_env')
